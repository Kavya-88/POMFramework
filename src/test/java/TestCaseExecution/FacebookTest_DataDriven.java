...
public class FacebookTest_DataDriven extends getExcelData {
    WebDriver driver;
    FacebookPage lp;
    Utilities ut;
	...
	@Test(dataProvider="getLoginData",priority = 0, enabled=true)
	public void LoginPageOne(String UserName , String Password) throws Exception {
		test =extent.createTest("LoginPageOne");
		lp = new FacebookPage(driver);
		ut = new Utilities(driver);
		lp.EmailOrPhoneNumber(UserName);
		ut.pause(1000);
		ut.EnterData(lp.Password(),Password);
		ut.pause(1000);
		lp.LoginButtons();
		ut.pause(10000);
	...
	public void tearDown(ITestResult result) throws Exception {
		 ...
		 if (result.getStatus() == ITestResult.FAILURE) {
			   ...
			   String screenshotPath = FacebookTest_DataDriven.getScreenshot(driver, result.getName());
